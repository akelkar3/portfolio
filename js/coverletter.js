...
self.letter = ko. observable(" ");
   self.copy = function(){
    var range = document.createRange();
             range.selectNode(document.getElementById("copyMe"));
...
self.create= function(){
    ...
    +"<br/>I am writing to apply for the "+self.position()+" position as posted on your website. My full-stack web development experience, proven creative and quality front-end development, and communication skills make me well suited for this position."
    ...
    +"<br/>I believe my profound experience to "
    +"<br/>"+self.JD1()
    +"<br/>"+self.JD2()
    +"<br/>"+self.JD3()
    +"<br/>"+self.JD4()
